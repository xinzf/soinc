 ...
 * description...
 *
 * @author     xiangzhi <xiangzhi@yoka.com>
 * @copyright  yyyy/mm/dd xiangzhi.
 */
ZEPHIR_INIT_CLASS(Soinc_Phalcon_Http_Curl_Extend) {

	ZEPHIR_REGISTER_CLASS(Soinc\\Phalcon\\Http\\Curl, Extend, soinc, phalcon_http_curl_extend, soinc_phalcon_http_curl_extend_method_entry, 0);

	/**
	 * curl 句柄
	 * @var [type]
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("handle"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求地址
	 * @var [type]
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("url"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求端口
	 * @var [type]
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("port"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求头
	 * @var array
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("headers"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求cookie
	 * @var [type]
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("cookie"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求UA
	 * @var [type]
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("user_agent"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求来源
	 * @var [type]
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("referer"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 请求POST数据
	 * @var array
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("postdata"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 默认头信息
	 * @var array
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("defaultHeaders"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * 默认CURL操作
	 * @var array
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("defaultOptions"), ZEND_ACC_PRIVATE TSRMLS_CC);

	/**
	 * HTTP CODE
	 * @var array
	 */
	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("_http_code"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("response_headers"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extend_ce, SL("response_body"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_string(soinc_phalcon_http_curl_extend_ce, SL("lastRequest"), "", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_string(soinc_phalcon_http_curl_extend_ce, SL("error"), "", ZEND_ACC_PRIVATE TSRMLS_CC);

	soinc_phalcon_http_curl_extend_ce->create_object = zephir_init_properties_Soinc_Phalcon_Http_Curl_Extend;
	return SUCCESS;
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extend, close) {
	...
	if (Z_TYPE_P(_0) == IS_RESOURCE) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_close", NULL, 7, _1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extend, setPort) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, port);
	ZEPHIR_CALL_FUNCTION(&_1, "is_integer", NULL, 8, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$3, "soinc/phalcon/http/curl/Extend.zep", 212 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extend, setPostData) {
	...
	if (Z_TYPE_P(postdata) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&_0$$3, "http_build_query", NULL, 9, postdata);
		zephir_check_call_status();
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extend, send) {
	...
	HashPosition _6;
	zval *headers;
	zval *_1 = NULL, *_2, *_3, *temp = NULL, *key = NULL, *value = NULL, *_4, *_5, **_8, *_10, *_11, _12 = zval_used_for_init, *_14, *_15, *_19, *_27, *_31, *_37, *response = NULL, *errno = NULL, *_41, *_42, *_43, *httpCode = NULL, *codes = NULL, *_46 = NULL, *_47, *_9$$3 = NULL, *_16$$4, *_17$$4, _18$$4, *_20$$5, *_23$$5, *_24$$5, _25$$5 = zval_used_for_init, *_26$$5, *_21$$6, *_22$$6 = NULL, *_28$$7, *_29$$7, _30$$7, *_32$$8, *_33$$8, _34$$8 = zval_used_for_init, *_35$$8, *_36$$8, *_38$$9, *_39$$9, _40$$9, *_44$$10, *_45$$10 = NULL, *_48$$11 = NULL, *_49$$11, *_50$$11;
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "curl_init", NULL, 10);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt_array", NULL, 11, _2, _3);
	zephir_check_call_status();
	...
	zephir_is_iterable(temp, &_7, &_6, 0, 0, "soinc/phalcon/http/curl/Extend.zep", 293);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_7, &_6)
		...
		zephir_array_append(&headers, _9$$3, PH_SEPARATE, "soinc/phalcon/http/curl/Extend.zep", 287);
	}
	...
	ZVAL_LONG(&_12, 10002);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _10, &_12, _11);
	zephir_check_call_status();
	_14 = zephir_fetch_nproperty_this(this_ptr, SL("handle"), PH_NOISY_CC);
	ZEPHIR_SINIT_NVAR(_12);
	ZVAL_LONG(&_12, 10023);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _14, &_12, headers);
	zephir_check_call_status();
	...
	if (zephir_is_true(_15)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _16$$4, &_18$$4, _17$$4);
		zephir_check_call_status();
	}
	_19 = zephir_fetch_nproperty_this(this_ptr, SL("postdata"), PH_NOISY_CC);
	if (zephir_is_true(_19)) {
		...
		if (Z_TYPE_P(_20$$5) == IS_ARRAY) {
			...
			ZEPHIR_CALL_FUNCTION(&_22$$6, "http_build_query", NULL, 9, _21$$6);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _23$$5, &_25$$5, _24$$5);
		zephir_check_call_status();
		_26$$5 = zephir_fetch_nproperty_this(this_ptr, SL("handle"), PH_NOISY_CC);
		ZEPHIR_SINIT_NVAR(_25$$5);
		ZVAL_LONG(&_25$$5, 47);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _26$$5, &_25$$5, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
	}
	...
	if (zephir_is_true(_27)) {
		...
		ZVAL_LONG(&_30$$7, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _28$$7, &_30$$7, _29$$7);
		zephir_check_call_status();
	}
	_31 = zephir_fetch_nproperty_this(this_ptr, SL("cookie"), PH_NOISY_CC);
	if (zephir_is_true(_31)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _32$$8, &_34$$8, _33$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _35$$8, &_34$$8, _36$$8);
		zephir_check_call_status();
	}
	_37 = zephir_fetch_nproperty_this(this_ptr, SL("referer"), PH_NOISY_CC);
	if (zephir_is_true(_37)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_13, 12, _38$$9, &_40$$9, _39$$9);
		zephir_check_call_status();
	}
	_41 = zephir_fetch_nproperty_this(this_ptr, SL("handle"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&response, "curl_exec", NULL, 13, _41);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&errno, "curl_errno", NULL, 14, _43);
	zephir_check_call_status();
	if (zephir_is_true(errno)) {
		_44$$10 = zephir_fetch_nproperty_this(this_ptr, SL("handle"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(&_45$$10, "curl_error", NULL, 15, _44$$10);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&httpCode, "curl_getinfo", NULL, 16, _47, &_12);
	zephir_check_call_status();
	if (!(zephir_fast_in_array(httpCode, codes TSRMLS_CC))) {
		...
		if (zephir_array_isset(_49$$11, httpCode)) {
			...
			zephir_array_fetch(&_48$$11, _50$$11, httpCode, PH_NOISY, "soinc/phalcon/http/curl/Extend.zep", 335 TSRMLS_CC);
		} else {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "parseresponse", NULL, 17, response);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "close", &_0, 0);
	zephir_check_call_status();
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extend, parseResponse) {
	...
	ZEPHIR_CALL_FUNCTION(&header_size, "curl_getinfo", NULL, 16, _0, &_1);
	zephir_check_call_status();
	...
	zephir_is_iterable(header, &_5, &_4, 0, 0, "soinc/phalcon/http/curl/Extend.zep", 387);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		zephir_is_iterable(temp$$3, &_9$$3, &_8$$3, 0, 0, "soinc/phalcon/http/curl/Extend.zep", 386);
		for (
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extend, setOptions) {
	...
	zephir_is_iterable(options, &_1, &_0, 0, 0, "soinc/phalcon/http/curl/Extend.zep", 414);
	for (
