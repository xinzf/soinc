...
ZEPHIR_INIT_CLASS(Soinc_Phalcon_Http_Curl_Extended) {
	...
	ZEPHIR_REGISTER_CLASS(Soinc\\Phalcon\\Http\\Curl, Extended, soinc, phalcon_http_curl_extended, soinc_phalcon_http_curl_extended_method_entry, 0);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("handle"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("url"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("port"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("headers"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("cookie"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("user_agent"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("referer"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("postdata"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("defaultHeaders"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("defaultOptions"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("_http_code"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("response_headers"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(soinc_phalcon_http_curl_extended_ce, SL("response_body"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_string(soinc_phalcon_http_curl_extended_ce, SL("lastRequest"), "", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_string(soinc_phalcon_http_curl_extended_ce, SL("error"), "", ZEND_ACC_PRIVATE TSRMLS_CC);

	soinc_phalcon_http_curl_extended_ce->create_object = zephir_init_properties_Soinc_Phalcon_Http_Curl_Extended;
	return SUCCESS;
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extended, setPort) {
	...
	if (!(zephir_is_true(_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$3, "soinc/phalcon/http/curl/extended.zep", 133 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extended, send) {
	...
	zephir_is_iterable(temp, &_7, &_6, 0, 0, "soinc/phalcon/http/curl/extended.zep", 189);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_7, &_6)
		...
		zephir_array_append(&headers, _9$$3, PH_SEPARATE, "soinc/phalcon/http/curl/extended.zep", 183);
	}
	...
	ZEPHIR_CALL_FUNCTION(&errcode, "curl_errno", NULL, 14, _43);
	zephir_check_call_status();
	...
	if (!(zephir_fast_in_array(httpCode, codes TSRMLS_CC))) {
		...
		if (zephir_array_isset(_49$$11, httpCode)) {
			...
			zephir_array_fetch(&_48$$11, _50$$11, httpCode, PH_NOISY, "soinc/phalcon/http/curl/extended.zep", 231 TSRMLS_CC);
		} else {
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extended, parseResponse) {
	...
	zephir_is_iterable(header, &_5, &_4, 0, 0, "soinc/phalcon/http/curl/extended.zep", 283);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		zephir_is_iterable(temp$$3, &_9$$3, &_8$$3, 0, 0, "soinc/phalcon/http/curl/extended.zep", 282);
		for (
...
PHP_METHOD(Soinc_Phalcon_Http_Curl_Extended, setOptions) {
	...
	zephir_is_iterable(options, &_1, &_0, 0, 0, "soinc/phalcon/http/curl/extended.zep", 312);
	for (
