...
PHP_METHOD(Soinc_Bootstrap, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_dir", NULL, 4, appPath);
	...
	if (!zephir_is_true(_0)) {
		...
		ZVAL_LONG(_3$$3, 1);
		ZEPHIR_CALL_METHOD(NULL, _1$$3, "__construct", NULL, 5, _2$$3, _3$$3);
		zephir_check_temp_parameter(_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(_1$$3, "soinc/bootstrap.zep", 32 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(_4);
...
PHP_METHOD(Soinc_Bootstrap, initEnv) {
	...
	ZEPHIR_CALL_FUNCTION(&env, "get_cfg_var", &_1, 6, &_0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&globalConfig, "get_cfg_var", &_1, 6, &_0);
	zephir_check_call_status();
	if (zephir_is_true(globalConfig)) {
		if (!((zephir_file_exists(globalConfig TSRMLS_CC) == SUCCESS))) {
			...
			ZVAL_LONG(_5$$6, 1);
			ZEPHIR_CALL_METHOD(NULL, _3$$6, "__construct", NULL, 5, _4$$6, _5$$6);
			zephir_check_call_status();
			zephir_throw_exception_debug(_3$$6, "soinc/bootstrap.zep", 56 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	...
	if ((zephir_file_exists(appConfigPath TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_METHOD(&_12$$8, this_ptr, "load", NULL, 7, appConfigPath);
		zephir_check_call_status();
...
PHP_METHOD(Soinc_Bootstrap, exec) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "initenv", NULL, 8);
	zephir_check_call_status();
	...
	if (!(zephir_array_isset(_0, _1))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Unsupported mode", "soinc/bootstrap.zep", 86);
		return;
	}
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(_6);
	...
	if (!(zephir_isset_property(_6, SS("mode") TSRMLS_CC))) {
		...
		ZVAL_LONG(_9$$4, 1);
		ZEPHIR_CALL_METHOD(NULL, _7$$4, "__construct", NULL, 5, _8$$4, _9$$4);
		zephir_check_temp_parameter(_8$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_7$$4, "soinc/bootstrap.zep", 90 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_array_fetch(&_11, _10, _12, PH_NOISY | PH_READONLY, "soinc/bootstrap.zep", 94 TSRMLS_CC);
...
PHP_METHOD(Soinc_Bootstrap, execTask) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "initbaseservice", NULL, 9);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "loadermodule", NULL, 10);
	zephir_check_call_status();
	...
	array_init(params);
	ZEPHIR_OBS_VAR(task);
	zephir_array_fetch_long(&task, argv, 1, PH_NOISY, "soinc/bootstrap.zep", 121 TSRMLS_CC);
	ZEPHIR_OBS_VAR(action);
	zephir_array_fetch_long(&action, argv, 2, PH_NOISY, "soinc/bootstrap.zep", 122 TSRMLS_CC);
	...
	ZEPHIR_CALL_FUNCTION(&params, "array_values", NULL, 11, argv);
	zephir_check_call_status();
...
PHP_METHOD(Soinc_Bootstrap, execWeb) {
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(e, zephir_get_internal_ce(SS("phalcon\\mvc\\application\\exception") TSRMLS_CC) TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_6$$4, "nl2br", NULL, 12, str$$4);
			zephir_check_call_status();
...
PHP_METHOD(Soinc_Bootstrap, execMicro) {
	...
	HashPosition _5$$3;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *argv = NULL, *app = NULL, *e = NULL, *handleFiles = NULL, *index = NULL, *file = NULL, *response = NULL, *_0, *_1 = NULL, *_2, *_3, *_4$$3, **_7$$3, *_8$$6 = NULL, *_9$$7 = NULL;
	...
	ZEPHIR_CALL_FUNCTION(&handleFiles, "glob", NULL, 13, _3);
	zephir_check_call_status();

	/* try_start_1: */

		_4$$3 = zephir_fetch_nproperty_this(this_ptr, SL("di"), PH_NOISY_CC);
		ZEPHIR_CALL_METHOD(NULL, app, "setdi", NULL, 0, _4$$3);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "initbaseservice", NULL, 9);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "loadermodule", NULL, 10);
		zephir_check_call_status_or_jump(try_end_1);
		zephir_is_iterable(handleFiles, &_6$$3, &_5$$3, 0, 0, "soinc/bootstrap.zep", 169);
		for (
		  ; zephir_hash_get_current_data_ex(_6$$3, (void**) &_7$$3, &_5$$3) == SUCCESS
		  ; zephir_hash_move_forward_ex(_6$$3, &_5$$3)
		) {
			ZEPHIR_GET_HMKEY(index, _6$$3, _5$$3);
			ZEPHIR_GET_HVALUE(file, _7$$3);
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(e, zephir_get_internal_ce(SS("phalcon\\exception") TSRMLS_CC) TSRMLS_CC)) {
			zend_clear_exception(TSRMLS_C);
			ZEPHIR_CALL_METHOD(&_8$$6, e, "getmessage", NULL, 0);
			zephir_check_call_status();
			zend_print_zval(_8$$6, 0);
		}
		ZEPHIR_CPY_WRT(e, EG(exception));
		if (zephir_instance_of_ev(e, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
			zend_clear_exception(TSRMLS_C);
			ZEPHIR_CALL_METHOD(&_9$$7, e, "getmessage", NULL, 0);
			zephir_check_call_status();
			zend_print_zval(_9$$7, 0);
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Soinc_Bootstrap, execSrv) {
...
PHP_METHOD(Soinc_Bootstrap, loaderModule) {
	...
	zval *_0, *_1, *module = NULL, *dirs = NULL, *namespaces = NULL, *services = NULL, *_2, *_3, *_5, *_6 = NULL, *_7 = NULL, *_8, *name = NULL, *obj = NULL, **_11, *_12$$5;
	int ZEPHIR_LAST_CALL_STATUS;
	...
	if (!((zephir_file_exists(_1 TSRMLS_CC) == SUCCESS))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Miss the Module.php", "soinc/bootstrap.zep", 217);
		return;
	}
	_2 = zephir_fetch_nproperty_this(this_ptr, SL("appPath"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(_3);
	ZEPHIR_CONCAT_VS(_3, _2, "Module.php");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "load", NULL, 7, _3);
	zephir_check_call_status();
	...
	if (!(zephir_instance_of_ev(module, soinc_abstractmodule_ce TSRMLS_CC))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "The module is not extends \\Soinc\\AbstractModule", "soinc/bootstrap.zep", 225);
		return;
	}
	...
	ZEPHIR_INIT_VAR(_7);
	ZVAL_BOOL(_7, 1);
	ZEPHIR_CALL_METHOD(&_6, _5, "registerdirs", NULL, 0, dirs, _7);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_7);
	ZVAL_BOOL(_7, 1);
	ZEPHIR_CALL_METHOD(NULL, _8, "registernamespaces", NULL, 0, namespaces, _7);
	zephir_check_call_status();
	zephir_is_iterable(services, &_10, &_9, 0, 0, "soinc/bootstrap.zep", 240);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_10, &_9)
		...
		ZEPHIR_CALL_METHOD(NULL, _12$$5, "set", NULL, 0, name, obj);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
