...
ZEPHIR_INIT_CLASS(Soinc_Logger_Processor_Trace) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Soinc\\Logger\\Processor, Trace, soinc, logger_processor_trace, soinc_logger_processor_abstractprocessor_ce, soinc_logger_processor_trace_method_entry, 0);

	zend_declare_property_null(soinc_logger_processor_trace_ce, SL("skipClassesPartials"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_long(soinc_logger_processor_trace_ce, SL("mode"), 0x0001, ZEND_ACC_PRIVATE TSRMLS_CC);

	soinc_logger_processor_trace_ce->create_object = zephir_init_properties_Soinc_Logger_Processor_Trace;
	zend_declare_class_constant_long(soinc_logger_processor_trace_ce, SL("T_FILE"), 0x0001 TSRMLS_CC);

	zend_declare_class_constant_long(soinc_logger_processor_trace_ce, SL("T_CLASS"), 0x0010 TSRMLS_CC);

	zend_declare_class_constant_long(soinc_logger_processor_trace_ce, SL("T_FULL"), 0x11 TSRMLS_CC);
...
PHP_METHOD(Soinc_Logger_Processor_Trace, __toString) {
	...
	CHECK:
	while (1) {
		zephir_array_fetch_long(&_1, trace, i, PH_READONLY, "soinc/logger/processor/trace.zep", 34 TSRMLS_CC);
		if (!(zephir_array_isset_string(_1, SS("class")))) {
			break;
		}
		_2$$3 = zephir_fetch_nproperty_this(this_ptr, SL("skipClassesPartials"), PH_NOISY_CC);
		zephir_is_iterable(_2$$3, &_4$$3, &_3$$3, 0, 0, "soinc/logger/processor/trace.zep", 42);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_4$$3, &_3$$3)
			...
			zephir_array_fetch_long(&_6$$4, trace, i, PH_NOISY | PH_READONLY, "soinc/logger/processor/trace.zep", 37 TSRMLS_CC);
			zephir_array_fetch_string(&_7$$4, _6$$4, SL("class"), PH_NOISY | PH_READONLY, "soinc/logger/processor/trace.zep", 37 TSRMLS_CC);
	...
	ZEPHIR_INIT_VAR(_9);
	zephir_array_fetch_long(&_10, trace, j, PH_READONLY, "soinc/logger/processor/trace.zep", 49 TSRMLS_CC);
	if (zephir_array_isset_string(_10, SS("file"))) {
		zephir_array_fetch_long(&_11, trace, j, PH_NOISY | PH_READONLY, "soinc/logger/processor/trace.zep", 49 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(_9);
		zephir_array_fetch_string(&_9, _11, SL("file"), PH_NOISY, "soinc/logger/processor/trace.zep", 49 TSRMLS_CC);
	} else {
		ZEPHIR_INIT_NVAR(_9);
	...
	zephir_array_fetch_long(&_12, trace, j, PH_READONLY, "soinc/logger/processor/trace.zep", 50 TSRMLS_CC);
	if (zephir_array_isset_string(_12, SS("line"))) {
		zephir_array_fetch_long(&_13, trace, j, PH_NOISY | PH_READONLY, "soinc/logger/processor/trace.zep", 50 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(_9);
		zephir_array_fetch_string(&_9, _13, SL("line"), PH_NOISY, "soinc/logger/processor/trace.zep", 50 TSRMLS_CC);
	} else {
		ZEPHIR_INIT_NVAR(_9);
		ZVAL_LONG(_9, -1);
	}
	...
	ZEPHIR_INIT_LNVAR(_9);
	zephir_array_fetch_long(&_14, trace, i, PH_READONLY, "soinc/logger/processor/trace.zep", 54 TSRMLS_CC);
	if (zephir_array_isset_string(_14, SS("class"))) {
		zephir_array_fetch_long(&_15, trace, i, PH_NOISY | PH_READONLY, "soinc/logger/processor/trace.zep", 54 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(_9);
		zephir_array_fetch_string(&_9, _15, SL("class"), PH_NOISY, "soinc/logger/processor/trace.zep", 54 TSRMLS_CC);
	} else {
		ZEPHIR_INIT_NVAR(_9);
		ZVAL_STRING(_9, "Nil", 1);
	}
	...
	ZEPHIR_INIT_LNVAR(_9);
	zephir_array_fetch_long(&_16, trace, i, PH_READONLY, "soinc/logger/processor/trace.zep", 55 TSRMLS_CC);
	if (zephir_array_isset_string(_16, SS("function"))) {
		zephir_array_fetch_long(&_17, trace, i, PH_NOISY | PH_READONLY, "soinc/logger/processor/trace.zep", 55 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(_9);
		zephir_array_fetch_string(&_9, _17, SL("function"), PH_NOISY, "soinc/logger/processor/trace.zep", 55 TSRMLS_CC);
	} else {
		ZEPHIR_INIT_NVAR(_9);
		ZVAL_STRING(_9, "Nil", 1);
	}
